...
let showHint = false;  // let showHint = true;
var dataMaps;
...
function retrieveInitialDataMaps() {
  // $.post(URL+'/retrieveInitialDataMaps', {}, (data) => {
  //   dataMaps = JSON.parse(data);
  //   console.log('data',dataMaps)
  //   visualizeDataMaps();
  // })
...
//   $.post(URL+'/queryAgent', queryObj, (data) => {
...
//   $.post(URL+'/queryCustomer', queryObj, (data) => {
...
//   $.post(URL+'/queryConversation', queryObj, (data) => {
...
//     $.post(URL+'/updateEntityMaps', query, (data) => {
//       counter -= 1;
...
//     $.post(URL+'/updateAgentMap', query, (data) => {
//       counter -= 1;
...
// main logic
$(document).ready(function() { retrieveInitialDataMaps(); });
// initUI();
// queryAgent({ query: '', cached: true, queryfromCache: true });
// queryCustomer({ query: '', cached: true, queryfromCache: true });
// queryConversation({ query: '', cached: true, queryfromCache: true });
